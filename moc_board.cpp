...
QT_MOC_LITERAL(1, 6, 16), // "signalTrapPlayer"
...
void board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalTrapPlayer((*reinterpret_cast< player(*)>(_a[1]))); break;
        case 1: _t->exploded((*reinterpret_cast< const bomb(*)>(_a[1]))); break;
        case 2: _t->end((*reinterpret_cast< player(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (board::*_t)(player & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&board::signalTrapPlayer)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void board::signalTrapPlayer(player & _t1)
{
